...
% \usepackage{amssymb}
\usepackage{esvect}
\input{preamble/math-setup}

\usepackage{enumitem}
\input{preamble/enum-setup}

\usepackage{caption}
\usepackage{titlesec}
\usepackage{fancyhdr}
\usepackage{extramarks}
\input{preamble/visuals}

\usepackage{etoolbox}

\usepackage[outputdir=build/aux, newfloat=true]{minted}

\input{preamble/minted-setup}
...
\usepackage{hyperref}
\usepackage{cleveref}
\input{preamble/cleveref-setup}
\usepackage{nameref}
\input{preamble/hyperref-setup}
